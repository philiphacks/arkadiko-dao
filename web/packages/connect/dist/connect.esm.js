...
import { serializeCV, serializePostCondition, ChainID, deserializeTransaction, BufferReader } from '@stacks/transactions';
...
var openTransactionPopup = function openTransactionPopup(_ref2) {
  ...
  void provider.transactionRequest(token).then(function (data) {
    ...
    var stacksTransaction = deserializeTransaction(new BufferReader(txBuffer));
...
export { ContractCallArgumentType, TransactionTypes, authenticate, authenticateWithExtensionUrl, defaultAuthURL, getOrCreateUserSession, getStacksProvider, getUserData, isMobile, isStacksWalletInstalled, makeContractCallToken, makeContractDeployToken, makeSTXTransferToken, openContractCall, openContractDeploy, openSTXTransfer, popupCenter, setupListener, shouldUsePopup, showBlockstackConnect, showConnect };
